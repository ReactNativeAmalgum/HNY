          ...
          <div className="footer-widget footer-list">
            ...
            <ul>
              ...
              <li>
                ...
                <span className="desc">
                A220, Business complex, LODHA AMARA, Kolshet Rd, Thane, Maharashtra 400607
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="col mb-8">
          <div className="footer-widget footer-list">
            ...
            <Link className="google-plus" to="">
              ...
              <Link className="facebook" to="">
                <i className="fa fa-facebook"><CiTwitter /></i>
              </Link>
            </ul>
          </div>
        </div>
    ...
    <div className="container">
      <div className="copyright text-center">
        <p>
          ...
          <a href="https://skdm.in/contact-us-digital-marketing"> shree krishns digital marketing </a>
          .
        </p>
      </div>
    </div>
